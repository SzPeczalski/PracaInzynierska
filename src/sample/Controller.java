...
public class Controller {
    ...
    @FXML
    private TextField w_01, w_02, w_03, w_04; //Pola tekstowe używane przy wprowdzaniu poszczególnych elementów wektora wag początkowych
    ...
    private void writeLog(){
        try{
            ...
            bw.newLine();
            bw.write("                                        "+dateFormat.format(date)+"r. "+timeFormat.format(date)+"                                     ");
            bw.newLine();
            bw.newLine();
            bw.write("--------------------------------------------------------------------------------------------------------");
            bw.newLine();
    ...
    private void makingCalculations1(){
        ...
        for (int i = 1; i <= krok; i++) {
            ...
            w1 = w1 + 0.05 * blad_uczenia * x1;
            w2 = w2 + 0.05 * blad_uczenia * x2;
            w3 = w3 + 0.05 * blad_uczenia * x3;
            w4 = w4 + 0.05 * blad_uczenia * x4;
    ...
    private void makingCalculations2(){
        ...
        for (int i=1;i<=krok;i++){
            ...
            w1 = w1 + 0.002*bigDelta*x1;
            w2 = w2 + 0.002*bigDelta*x2;
            w3 = w3 + 0.002*bigDelta*x3;
            w4 = w4 + 0.002*bigDelta*x4;
    ...
    private void makingCalculations4(){
        ...
        for (int i = 1; i <= krok; i++) {
            ...
            w12 = w1 + 0.05*blad_uczenia*y1;
            w22 = w2 + 0.05*blad_uczenia*y2;
            w32 = w3 + 0.05*blad_uczenia*y3;
            w42 = w4 + 0.05*blad_uczenia*y4;
            ...
            System.out.println("Wektor wag początkowych kroku W("+(i+1)+") = ["+ df.format(w12) + " ; " + df.format(w22) + " ; " + df.format(w32) + " ; " + df.format(w42) + "]");
            ...
            try {
                ...
                bw.write("Wektor wag początkowych kroku W("+i+") = {" + df.format(w1) + " ; " + df.format(w2) + " ; " + df.format(w3) + " ; " + df.format(w4) + "]");
                bw.newLine();
                bw.write("Wektor wag początkowych kroku W("+(i+1)+") = ["+ df.format(w12) + " ; " + df.format(w22) + " ; " + df.format(w32) + " ; " + df.format(w42) + "]");
                bw.newLine();
                bw.close();
